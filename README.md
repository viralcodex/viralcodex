...
| [f1-race-replay](https://github.com/IAmTomShaw/f1-race-replay) | [Add DRS zone visualization to race and qualifying replays](https://github.com/IAmTomShaw/f1-race-replay/pull/68) | `Open` |
| [svgo](https://github.com/svg/svgo) | [Add --hide-unchanged option to hide unchanged SVGs](https://github.com/svg/svgo/pull/2180) | `Open` |
