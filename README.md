...
| [opentui](https://github.com/anomalyco/opentui) | [(fix): select renderable buffer clear when options are removed](https://github.com/anomalyco/opentui/pull/850) | `Open` |
